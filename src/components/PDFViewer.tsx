...
const PDFViewer = ({ fileUrl, pdfViewer, setPdfViewer }: PDFViewerProps) => {
    return (
        <div className={`fixed top-0 right-0 h-full w-[800px] bg-white shadow-2xl transform transition-transform duration-300 ease-in-out z-50 px-6 ${pdfViewer ? 'translate-x-0' : 'translate-x-full'}`}>
